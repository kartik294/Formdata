...
//        }} className="flex flex-col">
//          <input value={username} onChange={(e)=>setUsername(e.target.value)} type="text" name="username" className="mb-4 p-2 border rounded" />
//          <button className="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
//            Submit
//         </button>
//      </form>
...
// Example of using Formdata and avoiding ref
  ...
  //      }} className="flex flex-col">
  //        <input  type="text" name="username" className="mb-4 p-2 border rounded" />
  //        <button className="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
  //          Submit
  //       </button>
  //     </form>
